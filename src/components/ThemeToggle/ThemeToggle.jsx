...
const changeTheme = (onChange) => {
  document.querySelector("html").classList.toggle(themes.light);
  onChange();
};
...
const ThemeToggle = (props) => {
  return (
    <div
      onClick={() => {
        changeTheme(props.onChange);
      }}
      className={`toggleWrapper ${props.theme === "dark" ? null : "light"}`}
    >
